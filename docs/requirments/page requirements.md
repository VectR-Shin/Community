...
- 게시글 상호작용
  - 게시글 상세 이동
  - 게시글 작성 이동 (로그인)
  - 공지글 작성 이동 (ADMIN, MANAGER, SUB_MANAGER)
...
- 게시글과 댓글, 대댓글이 수정될 경우, (수정됨) 표시를 추가한다.
- 게시글 삭제 시 사용자 확인 절차를 제공한다.
- 동일한 사용자는 동일한 게시글을 한 번만 신고할 수 있다.
- 동일한 사용자는 동일한 댓글을 한 번만 신고할 수 있다.
```
